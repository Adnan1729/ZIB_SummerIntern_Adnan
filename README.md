...
<p align="center">
  ...
  <br>
  <i>**Figure 1**: Comparative visualization of original images and their corresponding heatmaps generated by Integrated Gradients. The left column showcases the original images, while the right column presents the heatmaps, with the color intensity indicating the contribution magnitude. The colorbar accompanying each heatmap differentiates between positive (red) and negative (blue) contributions. Bounding boxes highlight regions of interest: the green bounding box represents the ground truth, whereas the red bounding box is derived from the heatmap.</i>
</p>
